...
import { checkSessionIdExist } from '../middlewares/chack-session-id.js'
...
export async function transactionsRoutes(server: FastifyInstance) {
    ...
    // irá passar primeiro pelo middleware (checkSessionIdExist) 
    ...
    server.get('/',
        ...
        , async (req, res) => {
            ...
            //Puxar transaçoes unicas || Valida se o cookie esta presente
    ...
    /* GET DE LISTAGEM DE SOMATORIO FINAL */
